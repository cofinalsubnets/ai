...
#define ai_data_n 7     // # of data sentinels (data.c go()); the KArr* kinds interleave, so no longer KTop-KVec
...
lvm_t lvm_ap, lvm_two, lvm_vec, lvm_sym, lvm_str, lvm_big, lvm_flo, lvm_wide; // sentinels + ap: data.c & inline predicates
