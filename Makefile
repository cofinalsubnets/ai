...
.PHONY: test_wm
test_wm: host
	@echo "WM wm/core.l + wm/layout.l + wm/wire.l + wm/manage.l + wm/keys.l + wm/law.l"; \
	  cat test/00-init.l wm/core.l wm/layout.l wm/wire.l wm/manage.l wm/keys.l wm/law.l | $m > out/host/.test_wm.out 2>&1; r=$$?; \
