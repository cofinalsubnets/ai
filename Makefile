...
hostnif_tests = boot/pty.l boot/net.l boot/phos.l boot/baoedit.l boot/baotest.l boot/init.l boot/fs.l boot/sh.l boot/cb.l boot/berth.l boot/manifest.l boot/pier.l boot/font.l boot/haven.l boot/overlay.l
