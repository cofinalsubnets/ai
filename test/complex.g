...
;   float > int/bignum. (cplx re im) builds one; `i` = (cplx 0 1) is the unit.
...
(assert
 ...
 (= (cplx 2 0) 2)                          ; cross-real equality (im 0)
 (= (cplx 2 0) 2.0)
 (= (+ 2 (* 3 i)) (cplx 2 3))              ; 2+3i built through the arith lanes
 ...
 (= (+ (cplx 1 2) (cplx 3 4)) (cplx 4 6))
 (= (- (cplx 1 2) (cplx 3 4)) (cplx -2 -2))
 (= (* (cplx 1 2) (cplx 3 4)) (cplx -5 10))
 (cclose (/ (cplx 1 2) (cplx 3 4)) (cplx 0.44 0.08))
 (= (* (cplx 0 2) i) -2)                   ; 2i * i = -2 (real), via cross-real =

 ; --- accessors ---
 (= 2.0 (re (cplx 2 3)))
 (= 3.0 (im (cplx 2 3)))
 (= (conj (cplx 2 3)) (cplx 2 -3))
