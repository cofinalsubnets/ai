...
; love's "undefined is nothing" (a type error is nil) reaches the floats -- the total order
...
; collector; out-of-pool constants are immortal. the love/ layer (prelude ev repl cli egg) drips
