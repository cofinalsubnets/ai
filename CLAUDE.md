...
; the core laws are ALSO machine-checked axiom-free in rocq/spec.v (wired into `make test_all` as
...
;   host/pty.c), cook (make-in-ai, cook/cook.l), wm (the X11 window manager, wm/), sat (the CDCL
;   solver, sat/), inle (freestanding agent-kernel, port/inle/). apps
