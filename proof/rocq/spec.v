...
(* THE COUNT LAW IS SHARED: numeral-apply (n f) composes f the SAME scount times.
   ...
   n-ary closure's fire-vs-hold (test/oracle.l, proof/rocq/extract.v). (Only the
...
(* ============================================================ *)
(* the Z lane: ONE model, shared with the generated proof/rocq/gen.v  *)
(* ============================================================ *)
(* The nat `app` (Nat.pow) above carries the numeral LAWS by clean unary induction.
   The GENERATED corpus checks (proof/rocq/gen.v, from tools/spec2coq.l) instead need Z --
